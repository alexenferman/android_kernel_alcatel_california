					    ...
					    struct wpa_ssid *group)
{
	...
	for (ssid = group; ssid; ssid = ssid->pnext) {
       ...
       //RR448065 BEGIN---Change WIFI 3G fall back by xiaoyong.wu
       //update this threshold for PR456114 by liangshuo.zhang@tcl.com 2013-05-20
       ...
       //RR448065 END---Change WIFI 3G fall back by xiaoyong.wu
...
//modified by liangshuo.zhang@tcl.com for T-Mobile's req with PR558856,20131122 begin
static struct wpa_bss *
			    ...
			    struct wpa_ssid **selected_ssid)
{
	...
	while (selected == NULL) {
	    char isChangePriority[10];
	    property_get("ro.wifi.priority.for.tm",isChangePriority,"0");
	    if(atoi(isChangePriority)){
...
//modified by liangshuo.zhang@tcl.com for T-Mobile's req with PR558856,20131122 end
