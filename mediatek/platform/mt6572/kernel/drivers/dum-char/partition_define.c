...
struct excel_info PartInfo[PART_NUM]={
			...
			{"custpack",642777088,0x3d80000, EMMC, 5,USER},
			{"mobile_info",8388608,0x2a280000, EMMC, 6,USER},
			{"expdb",10485760,0x2aa80000, EMMC, 0,USER},
			{"android",681574400,0x2b480000, EMMC, 7,USER},
			{"cache",394264576,0x53e80000, EMMC, 8,USER},
			{"usrdata",1073741824,0x6b680000, EMMC, 9,USER},
			{"fat",0,0xab680000, EMMC, 10,USER},
