...
//// White Locus    
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0060); //0x000E  //0x0080    //0x0032
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x001E); //0x0003  //0x001E    
...
// Outdoor Zone
    ...
    {
    	    0x0F,  0x12,
    			0x02,  0x72,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x0272);    
    			0x02,  0xA0,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x02A0);    
    			0x02,  0x5A,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x025A);    
    			0x02,  0xBC,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x02BC);    
    			0x02,  0x4A,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x024A);    
    			0x02,  0xC0,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x02C0);    
    			0x02,  0x3C,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x023C);    
    			0x02,  0xBE,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x02BE);    
    			0x02,  0x2E,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x022E);    
    			0x02,  0xBC,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x02BC);    
    			0x02,  0x24,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x0224);    
    			0x02,  0xB6,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x02B6);    
    			0x02,  0x18,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x0218);    
    			0x02,  0xAA,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x02AA);    
    			0x02,  0x10,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x0210);    
    			0x02,  0xA0,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x02A0);    
    			0x02,  0x0C,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x020C);    
    			0x02,  0x96,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x0296);    
    			0x02,  0x0A,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x020A);    
    			0x02,  0x8C,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x028C);    
    			0x02,  0x12,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x0212);    
    			0x02,  0x7E,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x027E);    
    			0x02,  0x34,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x0234);    
    			0x02,  0x56,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x0256);   
    			0x00,  0x04,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x0004);
    };
...
// Low Brightness Zone    
    ...
    static const kal_uint8 firmware18[50]=
    {
    	  0x0F,  0x12,  
    		0x05,  0x12,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x036C);    
    		0x05,  0x88,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x0408);    
    		0x04,  0x36,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x02D0);    
    		0x05,  0x68,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x038A);    
    		0x03,  0xCE,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x0262);    
    		0x04,  0xF0,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x0320);    
    		0x03,  0x5C,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x0222);    
    		0x04,  0x3A,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x02F4);    
    		0x02,  0xEA,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x01EA);    
    		0x03,  0x8A,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x02D4);    
    		0x02,  0x6E,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x01CC);    
    		0x03,  0x20,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x029E);    
    		0x02,  0x2C,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x01A4);    
    		0x02,  0xF4,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x027E);    
    		0x01,  0xEA,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x0184);    
    		0x02,  0xD4,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x0230);    
    		0x01,  0xCC,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x0000);    
    		0x02,  0x9E,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x0000);    
    		0x01,  0xA4,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x0000);    
    		0x02,  0x7E,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x0000);    
    		0x01,  0x84,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x0000);    
    		0x02,  0x30,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x0000);    
    		0x00,  0x00,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x0000);   
    		0x00,  0x00,   
    };    
    iBurstWriteReg(firmware18, 50, S5K5EAYX_WRITE_ID);
   ...
   // S5K5EAYX_write_cmos_sensor(0x0F12, 0x0000);    
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x000B);       //0x0008
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0000);
    S5K5EAYX_write_cmos_sensor(0x002A, 0x0E84);    
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0076);       //0x0136
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0000);
...
// Indoor Grid Offset     
    ...
    {
    	  0x0F,  0x12,
    		0xFF,  0x98,				//S5K5EAYX_write_cmos_sensor(0x0F12, 0xFF98);    
    		0xFF,  0x98,				//S5K5EAYX_write_cmos_sensor(0x0F12, 0xFF98);    
    		0xFF,  0x98,				//S5K5EAYX_write_cmos_sensor(0x0F12, 0xFF98);    
    		0x00,  0x00,				//S5K5EAYX_write_cmos_sensor(0x0F12, 0x0000);    
    		0x00,  0x00,				//S5K5EAYX_write_cmos_sensor(0x0F12, 0x0000);    
...
//==================================================================================
    ...
    {
    		0x0F,  0x12,
    		0x01,  0xC3,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x01C3); //TVAR_wbt_pBaseCcms[0] // Horizon         
    		0xFF,  0xD5,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0xFFD5); //TVAR_wbt_pBaseCcms[1]                    
    		0x00,  0x1F,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x001F); //TVAR_wbt_pBaseCcms[2]                    
    		0xFE,  0xF1,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0xFEF1); //TVAR_wbt_pBaseCcms[3]                    
    		0x01,  0x4E,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x014E); //TVAR_wbt_pBaseCcms[4]                    
    		0xFF,  0x18,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0xFF18); //TVAR_wbt_pBaseCcms[5]                    
    		...
    		0x01,  0x33,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x0133); //TVAR_wbt_pBaseCcms[9]                    
    		0x00,  0xD4,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x00D4); //TVAR_wbt_pBaseCcms[10]                   
    		0xFF,  0x7E,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0xFF7E); //TVAR_wbt_pBaseCcms[11]                   
    		0x01,  0x47,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x0147); //TVAR_wbt_pBaseCcms[12]                   
    		0xFF,  0x50,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0xFF50); //TVAR_wbt_pBaseCcms[13]                   
    		0x01,  0x51,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x0151); //TVAR_wbt_pBaseCcms[14]                   
    		0xFF,  0x82,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0xFF82); //TVAR_wbt_pBaseCcms[15]                   
    		0x01,  0xF7,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x01F7); //TVAR_wbt_pBaseCcms[16]                   
    		0x01,  0x44,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x0144); //TVAR_wbt_pBaseCcms[17]       
    		0x01,  0xC3,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x01C3);    //TVAR_wbt_pBaseCcms[18] // IncandA   
    		0xFF,  0xD5,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0xFFD5);    //TVAR_wbt_pBaseCcms[19]              
    		0x00,  0x1F,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x001F);    //TVAR_wbt_pBaseCcms[20]              
    		0xFE,  0xF1,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0xFEF1);    //TVAR_wbt_pBaseCcms[21]              
    		0x01,  0x4E,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x014E);    //TVAR_wbt_pBaseCcms[22]              
    		0xFF,  0x18,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0xFF18);    //TVAR_wbt_pBaseCcms[23]              
    		0xFF,  0xE6,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0xFFE6);    //TVAR_wbt_pBaseCcms[24]              
    		0xFF,  0xDD,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0xFFDD);    //TVAR_wbt_pBaseCcms[25]              
    		0x01,  0xB2,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x01B2);    //TVAR_wbt_pBaseCcms[26]              
    		0x01,  0x33,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x0133);    //TVAR_wbt_pBaseCcms[27]              
    		0x00,  0xD4,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x00D4);    //TVAR_wbt_pBaseCcms[28]              
    		0xFF,  0x7E,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0xFF7E);    //TVAR_wbt_pBaseCcms[29]              
    		0x01,  0x47,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x0147);    //TVAR_wbt_pBaseCcms[30]              
    		0xFF,  0x50,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0xFF50);    //TVAR_wbt_pBaseCcms[31]              
    		0x01,  0x51,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x0151);    //TVAR_wbt_pBaseCcms[32]              
    		0xFF,  0x82,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0xFF82);    //TVAR_wbt_pBaseCcms[33]              
    		0x01,  0xF7,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x01F7);    //TVAR_wbt_pBaseCcms[34]              
    		0x01,  0x44,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x0144);    //TVAR_wbt_pBaseCcms[35]       
    		0x01,  0xC3,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x01C3);   //TVAR_wbt_pBaseCcms[36] // WW      0002
    		0xFF,  0xD5,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0xFFD5);   //TVAR_wbt_pBaseCcms[37]            FFE5
    		0x00,  0x1F,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x001F);   //TVAR_wbt_pBaseCcms[38]            FEF8
    		...
    		0x01,  0x47,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x0147);   //TVAR_wbt_pBaseCcms[48]           
    		0xFF,  0x50,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0xFF50);   //TVAR_wbt_pBaseCcms[49]       
    		0x01,  0x51,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x0151);   //TVAR_wbt_pBaseCcms[50]       
    		0xFF,  0x82,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0xFF82);   //TVAR_wbt_pBaseCcms[51]       
    		0x01,  0xF7,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x01F7);   //TVAR_wbt_pBaseCcms[52]       
    		0x01,  0x44,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x0144);   //TVAR_wbt_pBaseCcms[53]       
    		0x01,  0xC3,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x01C3);   //01C7 //TVAR_wbt_pBaseCcms[54] // CW     /TVA
    		0xFF,  0xD5,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0xFFD5);   //FFD6 //TVAR_wbt_pBaseCcms[55]           /TVA
    		0x00,  0x1F,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x001F);   //000A //TVAR_wbt_pBaseCcms[56]           /TVA
    		...
    		0x01,  0x47,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x0147);   //0151 //TVAR_wbt_pBaseCcms[66]          
    		0xFF,  0x50,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0xFF50);   //FF50 //TVAR_wbt_pBaseCcms[67]          
    		0x01,  0x51,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x0151);   //0147 //TVAR_wbt_pBaseCcms[68]          
    		0xFF,  0x82,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0xFF82);   //FF75 //TVAR_wbt_pBaseCcms[69]          
    		0x01,  0xF7,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x01F7);   //0187 //TVAR_wbt_pBaseCcms[70]          
    		0x01,  0x44,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x0144);   //01BF //TVAR_wbt_pBaseCcms[71]     
    		0x01,  0xC3,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x01C3);   //01C7 //TVAR_wbt_pBaseCcms[72] // D50  
    		0xFF,  0xD5,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0xFFD5);   //FFD6 //TVAR_wbt_pBaseCcms[73]         
    		0x00,  0x1F,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x001F);   //000A //TVAR_wbt_pBaseCcms[74]         
    		...
    		0x01,  0x47,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x0147);   //0151 //TVAR_wbt_pBaseCcms[84]         
    		0xFF,  0x50,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0xFF50);   //FF50 //TVAR_wbt_pBaseCcms[85]         
    		0x01,  0x51,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x0151);   //0147 //TVAR_wbt_pBaseCcms[86]         
    		0xFF,  0x82,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0xFF82);   //FF75 //TVAR_wbt_pBaseCcms[87]         
    		0x01,  0xF7,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x01F7);   //0187 //TVAR_wbt_pBaseCcms[88]         
    		0x01,  0x44,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x0144);   //01BF //TVAR_wbt_pBaseCcms[89]       
    		0x01,  0xC3,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x01C3);  //0203 //01C7 //TVAR_wbt_pBaseCcms[90] // D65    
    		0xFF,  0xD5,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0xFFD5);  //FFAD //FFD6 //TVAR_wbt_pBaseCcms[91]           
    		0x00,  0x1F,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x001F);  //FFFB //000A //TVAR_wbt_pBaseCcms[92]           
    		...
    		0x01,  0x47,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x0147);  //0151 //01F3 //TVAR_wbt_pBaseCcms[102]          
    		0xFF,  0x50,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0xFF50);  //FF50 //FF7C //TVAR_wbt_pBaseCcms[103]          
    		0x01,  0x51,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x0151);  //0147 //01A6 //TVAR_wbt_pBaseCcms[104]          
    		0xFF,  0x82,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0xFF82);  //FF75 //FF06 //TVAR_wbt_pBaseCcms[105]          
    		0x01,  0xF7,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x01F7);  //0187 //01BA //TVAR_wbt_pBaseCcms[106]          
    		0x01,  0x44,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x0144);  //01BF //0108 //TVAR_wbt_pBaseCcms[107]     
    		0x02,  0x05,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x0205);   //0206 //TVAR_wbt_pOutdoorCcm[0] 
    		0xFF,  0xB7,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0xFFB7);   //FFD3 //TVAR_wbt_pOutdoorCcm[1] 
    		0xFF,  0xEF,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0xFFEF);   //FFD2 //TVAR_wbt_pOutdoorCcm[2] 
    		0xFF,  0x56,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0xFF56);   //FF56 //TVAR_wbt_pOutdoorCcm[3] 
    		0x01,  0xA2,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x01A2);   //01A2 //TVAR_wbt_pOutdoorCcm[4] 
    		0xFE,  0x5F,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0xFE5F);   //FE5F //TVAR_wbt_pOutdoorCcm[5] 
    		0xFF,  0xA6,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0xFFA6);   //FFA6 //TVAR_wbt_pOutdoorCcm[6] 
    		0x00,  0x21,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x0021);   //0021 //TVAR_wbt_pOutdoorCcm[7] 
    		0x01,  0x8E,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x018E);   //018E //TVAR_wbt_pOutdoorCcm[8] 
    		0x00,  0xF2,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x00F2);   //00F2 //TVAR_wbt_pOutdoorCcm[9] 
    		0x01,  0x1A,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x011A);   //011A //TVAR_wbt_pOutdoorCcm[10]
    		0xFF,  0x79,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0xFF79);   //FF79 //TVAR_wbt_pOutdoorCcm[11]
    		...
    		0xFF,  0x82,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0xFF82);   //FF75 //TVAR_wbt_pOutdoorCcm[15]
    		0x01,  0xF7,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x01F7);   //0187 //TVAR_wbt_pOutdoorCcm[16]
    		0x01,  0x44,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x0144);   //01BF //TVAR_wbt_pOutdoorCcm[17]
 		};
...
//         AFIT 1     
		static const kal_uint8 firmware23[162]=
		{
    		...
    		0x00,  0x00,				//S5K5EAYX_write_cmos_sensor(0x0F12, 0x0000);    //AFIT16_BRIGHTNESS                                                                                   
    		0x00,  0x00,				//S5K5EAYX_write_cmos_sensor(0x0F12, 0x0000);    //AFIT16_CONTRAST                                                                                     
    		0x00,  0x09,				//S5K5EAYX_write_cmos_sensor(0x0F12, 0x0009);    //AFIT16_SATURATION                                                                                   
    		0x00,  0x00,				//S5K5EAYX_write_cmos_sensor(0x0F12, 0x0000);    //AFIT16_SHARP_BLUR                                                                                   
    		0x00,  0x00,				//S5K5EAYX_write_cmos_sensor(0x0F12, 0x0000);    //AFIT16_GLAMOUR                                                                                      
...
//AFIT 2    
    static const kal_uint8 firmware24[162]=
    {
    		...
    		0x00,  0x00,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x0000);    //AFIT16_BRIGHTNESS                                                                                   
    		0x00,  0x00,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x0000);    //AFIT16_CONTRAST                                                                                     
    		0x00,  0x0E,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x000E);    //AFIT16_SATURATION                                                                                   
    		0x00,  0x00,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x0000);    //AFIT16_SHARP_BLUR                                                                                   
    		0x00,  0x00,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x0000);    //AFIT16_GLAMOUR                                                                                      
    		0x00,  0x50,					//S5K5EAYX_write_cmos_sensor(0x0F12, 0x0050);    //AFIT16_EE_iFlatBoundary                                                                             
 ...
 //AFIT 3    
    static const kal_uint8 firmware25[162]=
    {
    	    0x0F,  0x12,
    			0x00,  0x00,			//S5K5EAYX_write_cmos_sensor(0x0F12, 0x0000);    //AFIT16_BRIGHTNESS                                                                                   
    			0x00,  0x00,			//S5K5EAYX_write_cmos_sensor(0x0F12, 0x0000);    //AFIT16_CONTRAST                                                                                     
    			0x00,  0x0D,			//S5K5EAYX_write_cmos_sensor(0x0F12, 0x000D);    //AFIT16_SATURATION                                                                                   
    			0x00,  0x00,			//S5K5EAYX_write_cmos_sensor(0x0F12, 0x0000);    //AFIT16_SHARP_BLUR                                                                                   
    			0x00,  0x00,			//S5K5EAYX_write_cmos_sensor(0x0F12, 0x0000);    //AFIT16_GLAMOUR                                                                                      
    			0x00,  0x50,			//S5K5EAYX_write_cmos_sensor(0x0F12, 0x0050);    //AFIT16_EE_iFlatBoundary                                                                             
    			0x00,  0x30,			//S5K5EAYX_write_cmos_sensor(0x0F12, 0x0030);    //AFIT16_Yuvemix_mNegRanges_0                                                                         
  ...
  //AFIT 4    
    static const kal_uint8 firmware26[162]=
    {
    		...
    		0x00, 0x00,							//S5K5EAYX_write_cmos_sensor(0x0F12, 0x0000);    //AFIT16_CONTRAST                                                                                     
    		0x00, 0x08,							//S5K5EAYX_write_cmos_sensor(0x0F12, 0x0008);    //AFIT16_SATURATION                                                                                   
    		0x00, 0x00,							//S5K5EAYX_write_cmos_sensor(0x0F12, 0x0000);    //AFIT16_SHARP_BLUR                                                                                   
    		0x00, 0x00,							//S5K5EAYX_write_cmos_sensor(0x0F12, 0x0000);    //AFIT16_GLAMOUR                                                                                      
    		...
    		0x1C, 0x1F,							//S5K5EAYX_write_cmos_sensor(0x0F12, 0x1C1F);    //AFIT8_Yuviirnr_iUVNRStrengthL [7:0] AFIT8_Yuviirnr_iUVNRStrengthH [15:8]                            
    		0x80, 0x80,							//S5K5EAYX_write_cmos_sensor(0x0F12, 0x8080);    //AFIT8_byr_gras_iShadingPower [7:0] AFIT8_RGBGamma2_iLinearity [15:8]                                
    		0x80, 0x00,							//S5K5EAYX_write_cmos_sensor(0x0F12, 0x8000);    //AFIT8_RGBGamma2_iDarkReduce [7:0] AFIT8_ccm_oscar_iSaturation [15:8]                                
    		0x80, 0x00,							//S5K5EAYX_write_cmos_sensor(0x0F12, 0x8000);    //AFIT8_RGB2YUV_iYOffset [7:0] AFIT8_RGB2YUV_iRGBGain [15:8]                                          
